...
class Ticket extends Component {
    ...
    render() {
        const { incident, ticket, ticketSystem, dispatch } = this.props

        if(incident && incident.error)
        {
            return ErrorLoadingIncident(incident)
        }
        ...
        {
            return <DisplayIncident incident={incident} ticket={ticket} ticketSystem={ticketSystem} />
        }
        return (
