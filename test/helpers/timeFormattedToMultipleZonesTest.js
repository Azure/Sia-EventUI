...
describe('timeFormattedToMultipleZones', function test () {
  ...
  context('over yesterday and today', () => {
    ...
    it('defaults to displaying time for Pacific, India, and UTC', () => {
      expect(timeFormattedToMultipleZones(time)).to.contain(pacific, india, utc)
    })
    ...
    it('groups times by day', () => {
      let expected = '1969-12-31 16:00:00 PT; 1970-01-01 05:30:00 IST, 00:00:00 UTC'
  ...
  context('In a single day', () => {
    ...
    it('groups times by day', () => {
      let expected = '1970-01-01 00:00:00 PT, 13:30:00 IST, 08:00:00 UTC'
  ...
  context('over today and tomorrow', () => {
    ...
    it('groups times by day', () => {
      let expected = '1970-01-01 10:30:00 PT, 18:30:00 UTC; 1970-01-02 00:00:00 IST'
